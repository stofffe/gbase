...
impl GlbLoader {
    fn pixel_cache(
        ...
        let image = Image {
            texture: TextureBuilder::new(render::TextureSource::Data(1, 1, value.to_vec())),
                ...
                for primitive in mesh.primitives() {
                    ...
                    let indices = match indices_attr.data_type() {
                        ...
                        gltf::accessor::DataType::U32 => {
                            bytemuck::cast_slice::<u8, u32>(&buffer[offset..offset + length])
                                .to_vec()
                        }
