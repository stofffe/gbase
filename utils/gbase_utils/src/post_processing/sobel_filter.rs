...
pub struct SobelFilter {
    ...
    params_buffer: render::UniformBuffer<SobelFilterParams>,
...
impl SobelFilter {
    pub fn new(ctx: &mut Context) -> Self {
        let shader = render::ShaderBuilder::new(
            include_str!("../../assets/shaders/sobel_filter.wgsl").to_string(),
        )
        .build(ctx);
...
#[derive(ShaderType)]
pub struct SobelFilterParams {
    kernel_size: i32,
}

impl SobelFilterParams {
